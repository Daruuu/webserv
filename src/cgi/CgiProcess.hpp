...
class CgiProcess {
  public:
     ...
     */
    CgiProcess(const std::string& script_path, const std::string& interpreter, int pipe_in_write,
    ...
    void advanceBodyBytesWritten(size_t n) {
        body_bytes_written_ += n;
    }
    ...
    const std::string& getCompleteResponse() const {
        return complete_response_;
    }
