...
class CgiExecutor {
  public:
     ...
     */
    CgiProcess* executeAsync(const HttpRequest& request, const std::string& script_path,
  ...
  private:
     ...
     */
    std::map< std::string, std::string > prepareEnvironment(const HttpRequest& request,
